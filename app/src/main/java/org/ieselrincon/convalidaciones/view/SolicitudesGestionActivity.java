...
public class SolicitudesGestionActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    return SolicitudListFragment.newInstance(position + 1, G.OPERACION_CONSULTAR, mUsuarioLoginId); //falta arreglar esto
            }
            return null;
        }

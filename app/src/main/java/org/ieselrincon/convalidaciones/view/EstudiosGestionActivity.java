...
public class EstudiosGestionActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    return EstudioListFragment.newInstance(position + 1, G.OPERACION_CONSULTAR, G.ADMINISTRADOR); //falta arreglar esto
            }
            return null;
        }

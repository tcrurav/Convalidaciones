...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mLinkSignUpTextView = (TextView) findViewById(R.id.link_signup);
        mLinkSignUpTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent act = new Intent(contexto, SignUpActivity.class);
                startActivity(act);
                finish();
            }
        });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Usuario usuario = UsuarioControl.login(getContentResolver(),mEmail,mPassword);

            if(usuario!=null){
                mUsuarioLoginId = usuario.getID();
                return true;
            }

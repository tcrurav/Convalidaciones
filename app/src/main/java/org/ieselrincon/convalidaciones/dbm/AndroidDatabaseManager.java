...
package org.ieselrincon.convalidaciones.dbm;
...
import org.ieselrincon.convalidaciones.model.proveedor.ProveedorDeContenido;
...
public class AndroidDatabaseManager extends Activity implements OnItemClickListener {
	...
	public void onStart() {
		...
		Action viewAction = Action.newAction(
				...
				Uri.parse("android-app://com.merchandges.dbm/http/host/path")
		);
...
// all global variables
	...
	ProveedorDeContenido.DatabaseHelper dbm;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = new ProveedorDeContenido.DatabaseHelper(AndroidDatabaseManager.this);
	...
	public void updateDeletePopup(int row) {
		...
		//lcrud.setId(299); //Valor antiguo que ahora da error (TIBU)
		lcrud.setId(R.id.lcrud); //Lo metí nuevo para que funcionara. Junto a res/values/ids.xml que añadí nuevo (TIBU)
